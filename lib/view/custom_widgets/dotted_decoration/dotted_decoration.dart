...
//     return _DottedDecoratedPainter(shape, linePosition, color, borderRadius, dash, strokeWidth);
//   }
// }

// class _DottedDecoratedPainter extends BoxPainter {
...
//   List<int> dash;
//   double strokeWidth;
//   _DottedDecoratedPainter(this.shape, this.linePosition, this.color, this.borderRadius, this.dash, this.strokeWidth) {
