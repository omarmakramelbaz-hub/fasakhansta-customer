...
class ChatController extends ChangeNotifier {
  ...
  void initial(String id) {
    ...
    chatStream = _firestore
        .collection('orderChat') //colllection of dash
        .doc(orderId.toString()) //rome_id sored from snall to larg num =========== user [1 ==189]
        .collection('chat') // collection messages ===> snapshot
        .snapshots();
    notifyListeners();
  }
