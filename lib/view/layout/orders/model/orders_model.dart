...
class Items {
  int? id;
  ResturantProduct? restaurantProduct;
  int? resturantId;
  String? resturantName;
  String? resturantLat;
  String? resturantLng;
  ...
  Items copyWith({int? id, ResturantProduct? restaurantProduct, int? qty}) {
    return Items(
      id: id ?? this.id,
      restaurantProduct: restaurantProduct ?? this.restaurantProduct,
      qty: qty ?? this.qty,
    );
  }
  ...
  Items.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    restaurantProduct = json['resturant_product'] != null ? ResturantProduct.fromJson(json['resturant_product']) : null;
    resturantId = json['resturant_id'];
    resturantName = json['resturant_name'];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (restaurantProduct != null) {
      data['resturant_product'] = restaurantProduct!.toJson();
    }
    data['resturant_id'] = resturantId;
    data['resturant_name'] = resturantName;
