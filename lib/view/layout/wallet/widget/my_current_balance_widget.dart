      ...
      child: Stack(
        children: [
          Positioned(
            right: -30,
            bottom: -35,
            child: Icon(Icons.account_balance_wallet_outlined, size: 170, color: Colors.white.withValues(alpha: .08)),
          ),
          Column(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(_visible ? 'إخفاء الرصيد' : 'إظهار الرصيد', style: AppTextStyle.text16MS().copyWith(color: Colors.white)),
                ],
              ),
            ],
          ),
